...
public class LoginGraphic {
    ...
    public void signIn(String username, String password, boolean store) throws UserLoginFailedException, NoInterfaceException, FileNotFoundException, SQLException {
